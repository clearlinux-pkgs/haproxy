...
%prep
%setup -q -n haproxy-2.0.29
cd %{_builddir}/haproxy-2.0.29
pushd ..
cp -a haproxy-2.0.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656124254
...
cp %{_builddir}/haproxy-2.0.29/doc/gpl.txt %{buildroot}/usr/share/package-licenses/haproxy/9a13113b89f7985efe22a28b8e4ad1ace7f2b5d1
cp %{_builddir}/haproxy-2.0.29/ebtree/LICENSE %{buildroot}/usr/share/package-licenses/haproxy/caeb68c46fa36651acf592771d09de7937926bb3
pushd ../buildavx2/
