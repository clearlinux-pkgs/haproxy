...
Version  : 1.8.20
Release  : 23
URL      : https://www.haproxy.org/download/1.8/src/haproxy-1.8.20.tar.gz
Source0  : https://www.haproxy.org/download/1.8/src/haproxy-1.8.20.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1561875418
...
make  %{?_smp_mflags} TARGET=linux2628 USE_PCRE=1 USE_OPENSSL=1 USE_ZLIB=1 USE_SYSTEMD=1
