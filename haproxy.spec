...
Version  : 2.0.23
Release  : 34
URL      : https://www.haproxy.org/download/2.0/src/haproxy-2.0.23.tar.gz
Source0  : https://www.haproxy.org/download/2.0/src/haproxy-2.0.23.tar.gz
...
%prep
%setup -q -n haproxy-2.0.23
cd %{_builddir}/haproxy-2.0.23
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626445338
...
cp %{_builddir}/haproxy-2.0.23/LICENSE %{buildroot}/usr/share/package-licenses/haproxy/99ea8073325ff4a755b6f2fa5862fc3e722f4647
cp %{_builddir}/haproxy-2.0.23/doc/gpl.txt %{buildroot}/usr/share/package-licenses/haproxy/9a13113b89f7985efe22a28b8e4ad1ace7f2b5d1
cp %{_builddir}/haproxy-2.0.23/ebtree/LICENSE %{buildroot}/usr/share/package-licenses/haproxy/caeb68c46fa36651acf592771d09de7937926bb3
